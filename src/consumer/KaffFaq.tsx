...
export const FAQ_GROUPS: FaqGroup[] = [
  {
    ...
    qs: [
      ...
      { q: 'Kaff หักค่าธรรมเนียมเท่าไร?', a: '**ไม่หักครับ — 100% ของยอดที่ท่านบริจาคถึงผู้รับ/พันธมิตรปลายทาง** ใช้ได้กับทุกประเภท (Riba · Zakat · Fitrah · Fidyah · Kaffarah · Qurban · Sadaqah)\n\nKaff อยู่ได้ด้วย "การสนับสนุนโดยสมัครใจ" จากผู้ใช้ — หลังบริจาคจบ ระบบจะมีปุ่มเล็กๆ ให้ท่านส่งเงินสนับสนุน Kaff ได้ถ้าต้องการ · ไม่บังคับ · กดข้ามได้ทุกเมื่อ\n\nเหตุผลที่ Kaff เลือกโมเดลนี้: เราไม่ได้บริหาร logistics เอง (เช่น Qurban เราส่งคำสั่งให้ Ummatee) จึงไม่เหมาะที่จะเรียกตัวเองว่า "Amil" ตามหลักศาสนา — ดอกผลของท่านจึงควรถึงผู้รับเต็มจำนวน' },
      ...
      { q: 'ฉันต้องลงทะเบียนไหม?', a: 'ลงทะเบียนเพื่อเก็บประวัติการบริจาคและรับใบเสร็จออนไลน์ได้ แต่บริจาคแบบไม่ระบุชื่อก็ทำได้ในทุกฟีเจอร์' },
    ],
  },
  {
  ...
  },
  {
    ...
    qs: [
      ...
      { q: 'ขอใบเสร็จลดหย่อนภาษีได้ไหม?', a: 'ทุกการบริจาคจะได้รับใบเสร็จออนไลน์ทางอีเมลทันที ส่วนใบเสร็จสำหรับลดหย่อนภาษีกำลังอยู่ระหว่างจัดเตรียม — จะเปิดให้บริการเมื่อองค์กรปลายทางที่ลดหย่อนได้พร้อม เราจะแจ้งให้ทราบ' },
      { q: 'รับ USDC/Crypto ไหม?', a: 'รับ — USDC บน Base mainnet (Coinbase L2) · gas ต่ำ ~$0.01 · ใช้ Coinbase Wallet, MetaMask Mobile, หรือ Rainbow scan QR ก็โอนได้ใน 1 นาที · อัตราแปลง THB↔USDC คำนวณสดจาก CoinGecko' },
    ],
  },
];
